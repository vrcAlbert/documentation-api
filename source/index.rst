...
Les sources sont sur `Git Hub <https://github.com/novius-os/documentation-fr>`_, nous attendons vos ``Pull Request`` avec impatience.
`Contactez-nous <http://www.novius-os.org/fr/footer/contacts.html>`_ si vous avez besoin d'aide avec votre contribution.
