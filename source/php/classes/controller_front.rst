...
.. php:staticmethod:: setBaseHref($base_href)
	...
	:param string $base_href: Set a new ``base_href`` for current webpage HTML output.

.. php:staticmethod:: setTitle($title, $template = null)

	:param string $title: Set a new title for current webpage HTML output.
	:param string $template: If set, use it for calculate title. Placeholder ``:title`` will be replaced by ``$title``.

.. php:staticmethod:: setMetaDescription($meta_description)

	:param string $meta_description: Set a meta description for current webpage HTML output.

.. php:staticmethod:: setMetaKeywords($meta_keywords)

	:param string $meta_keywords: Set a meta keywords for current webpage HTML output.

.. php:staticmethod:: setMetaRobots($meta_robots)

	:param string $meta_robots: Set a meta robots for current webpage HTML output.

.. php:staticmethod:: addMeta($meta)

	:param string $meta: A HTML meta tag to add at the current webpage HTML output.

.. php:staticmethod:: addJavascript($url, $footer = true)

	:param string $url: URL of a Javascript library to add at the current webpage HTML output.
...
.. php:staticmethod:: addJavascriptInline($js, $footer = true)
	...
	:param string $url: Javascript code to add at the current webpage HTML output.
	:param boolea $footer: If ``true``, add ``script`` at the end of HTML output. If ``false``, add in the ``<head>``.

.. php:staticmethod:: addCss($url)

	:param string $url: URL of a CSS file to add at the current webpage HTML output.

.. php:staticmethod:: addCssInline($css)

	:param string $css: CSS code to add at the current webpage HTML output.
